...
//we need to go deeper.
    jumbleMngr = [new jumble("cthulhu1", "While Cthulhu has been greatly popularized by many modern games, but what story started it all?", "Call of Cthulhu", "The Hobbit", "Harry Potter", "Necronomicon", "images/KazumaKaneko-Cthulu.jpg", "CTHULHU: PH'NGLUI MGLW'NAFH CTHULHU R'LYEH WGAH'NAGL FHTAGN!!!", "easy"),
        ...
        new jumble("quetzalcoatl1", "Quetzalcoatl was regarded as the god of water, wind, and the harvest, and the god who gave man fire. His efforts to get people to stop making human sacrifices earned the wrath of the war god, Tezcatlipoca, who banished him to which planet?", "Mars", "Venus", "Saturn", "Jupiter", "images/KazumaKaneko-Quetzalcoatl.jpg", "QUETZALCOATL: Mortals seem to have forgotten that gifts are all around them. Perhaps it is time for another purge.", "hard"),
